...
%dim.symmetry_sectors = 1;
dim.symmetry_sectors = dim.p*2;
dim.number_of_airgap_layers = 4;
...
dim.h_sleeve = 3.5e-3; %retaining sleeve thickness
dim.hpm = 6e-3; %PM thickness
dim.alpha_pm = 0.7; %PM pitch, as a ratio to pole pitch
dim.is_halbach = true;

dim.lcar_mag = dim.hpm / 10;
